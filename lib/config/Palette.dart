...
class Palette{
  ...
  static Color sentMessageBackgroundColor = Color(0xff4fc3f7);
  static Color receiveMessageBackgroundColor = Colors.white;
  static Color sentMessageColor = Colors.white;
  static Color receiveMessageColor = Color(0xff3f3f3f);
